...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/annotations', true);
    }
    ...
    protected function getAssetic_AssetManagerService()
    {
        ...
        $this->services['assetic.asset_manager'] = $instance = new \Assetic\Factory\LazyAssetManager($this->get('assetic.asset_factory'), array('twig' => new \Assetic\Factory\Loader\CachedFormulaLoader(new \Assetic\Extension\Twig\TwigFormulaLoader($this->get('twig')), new \Assetic\Cache\ConfigCache('/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/assetic/config'), true)));

        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\CoalescingDirectoryResource(array(0 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BloggerBlogBundle', '/Applications/XAMPP/xamppfiles/htdocs/blog/app/Resources/BloggerBlogBundle/views', '/\\.[^.]+\\.twig$/'), 1 => new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, 'BloggerBlogBundle', '/Applications/XAMPP/xamppfiles/htdocs/blog/src/Blogger/BlogBundle/Resources/views', '/\\.[^.]+\\.twig$/'))), 'twig');
        $instance->addResource(new \Symfony\Bundle\AsseticBundle\Factory\Resource\DirectoryResource($a, '', '/Applications/XAMPP/xamppfiles/htdocs/blog/app/Resources/views', '/\\.[^.]+\\.twig$/'), 'twig');
    ...
    {
        $this->services['assetic.filter.yui_css'] = $instance = new \Assetic\Filter\Yui\CssCompressorFilter('/Applications/XAMPP/xamppfiles/htdocs/blog/app/Resources/java/yuicompressor-2.4.6.jar', '/usr/bin/java');
    ...
    protected function getCacheWarmerService()
    {
        ...
        $c = new \Symfony\Bundle\FrameworkBundle\CacheWarmer\TemplateFinder($a, $b, '/Applications/XAMPP/xamppfiles/htdocs/blog/app/Resources');
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        ...
        $b->setNamespace('sf2orm_default_e98486f679ab4141263d55b938d030512e0c4ca9ceacc8f6bed8e777d62d6a9d');

        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_e98486f679ab4141263d55b938d030512e0c4ca9ceacc8f6bed8e777d62d6a9d');

        $d = new \Doctrine\Common\Cache\ArrayCache();
        $d->setNamespace('sf2orm_default_e98486f679ab4141263d55b938d030512e0c4ca9ceacc8f6bed8e777d62d6a9d');

        $e = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver($a, array(0 => '/Applications/XAMPP/xamppfiles/htdocs/blog/src/Blogger/BlogBundle/Entity', 1 => '/Applications/XAMPP/xamppfiles/htdocs/blog/src/Blogger/AccountBundle/Entity'));

        $f = new \Doctrine\ORM\Mapping\Driver\DriverChain();
        $f->addDriver($e, 'Blogger\\BlogBundle\\Entity');
        $f->addDriver($e, 'Blogger\\AccountBundle\\Entity');

        $g = new \Doctrine\ORM\Configuration();
        $g->setEntityNamespaces(array('BloggerBlogBundle' => 'Blogger\\BlogBundle\\Entity', 'BloggerAccountBundle' => 'Blogger\\AccountBundle\\Entity'));
        $g->setMetadataCacheImpl($b);
        $g->setQueryCacheImpl($c);
        $g->setResultCacheImpl($d);
        $g->setMetadataDriverImpl($f);
        $g->setProxyDir('/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/doctrine/orm/Proxies');
    ...
    {
        return $this->services['file_locator'] = new \Symfony\Component\HttpKernel\Config\FileLocator($this->get('kernel'), '/Applications/XAMPP/xamppfiles/htdocs/blog/app/Resources');
    }
    ...
    {
        return $this->services['monolog.handler.main'] = new \Monolog\Handler\StreamHandler('/Applications/XAMPP/xamppfiles/htdocs/blog/app/logs/dev.log', 100, true);
    }
    ...
    protected function getProfilerService()
    {
        ...
        $this->services['profiler'] = $instance = new \Symfony\Component\HttpKernel\Profiler\Profiler(new \Symfony\Component\HttpKernel\Profiler\FileProfilerStorage('file:/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/profiler', '', '', 86400), $a);
    ...
    {
        return $this->services['router'] = new \Symfony\Bundle\FrameworkBundle\Routing\Router($this, '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/assetic/routing.yml', array('cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev', 'debug' => true, 'generator_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_base_class' => 'Symfony\\Component\\Routing\\Generator\\UrlGenerator', 'generator_dumper_class' => 'Symfony\\Component\\Routing\\Generator\\Dumper\\PhpGeneratorDumper', 'generator_cache_class' => 'appDevUrlGenerator', 'matcher_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_base_class' => 'Symfony\\Bundle\\FrameworkBundle\\Routing\\RedirectableUrlMatcher', 'matcher_dumper_class' => 'Symfony\\Component\\Routing\\Matcher\\Dumper\\PhpMatcherDumper', 'matcher_cache_class' => 'appDevUrlMatcher', 'strict_requirements' => true), $this->get('router.request_context', ContainerInterface::NULL_ON_INVALID_REFERENCE), $this->get('monolog.logger.router', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        $this->services['sensio_distribution.webconfigurator'] = $instance = new \Sensio\Bundle\DistributionBundle\Configurator\Configurator('/Applications/XAMPP/xamppfiles/htdocs/blog/app');
    ...
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/sessions', 'MOCKSESSID', $this->get('session.storage.metadata_bag'));
    }
    ...
    {
        return $this->services['templating.helper.code'] = new \Symfony\Bundle\FrameworkBundle\Templating\Helper\CodeHelper(NULL, '/Applications/XAMPP/xamppfiles/htdocs/blog/app', 'UTF-8');
    }
    ...
    {
        return $this->services['translator.default'] = new \Symfony\Bundle\FrameworkBundle\Translation\Translator($this, $this->get('translator.selector'), array('translation.loader.php' => array(0 => 'php'), 'translation.loader.yml' => array(0 => 'yml'), 'translation.loader.xliff' => array(0 => 'xlf', 1 => 'xliff'), 'translation.loader.po' => array(0 => 'po'), 'translation.loader.mo' => array(0 => 'mo'), 'translation.loader.qt' => array(0 => 'ts'), 'translation.loader.csv' => array(0 => 'csv'), 'translation.loader.res' => array(0 => 'res'), 'translation.loader.dat' => array(0 => 'dat'), 'translation.loader.ini' => array(0 => 'ini'), 'translation.loader.json' => array(0 => 'json')), array('cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/translations', 'debug' => true));
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => true, 'strict_variables' => true, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/twig', 'charset' => 'UTF-8', 'paths' => array()));
        ...
        $instance->addExtension(new \Symfony\Bridge\Twig\Extension\CodeExtension(NULL, '/Applications/XAMPP/xamppfiles/htdocs/blog/app', 'UTF-8'));
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/vendor/symfony/symfony/src/Symfony/Bundle/FrameworkBundle/Resources/views', 'Framework');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/vendor/symfony/symfony/src/Symfony/Bundle/SecurityBundle/Resources/views', 'Security');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/vendor/symfony/symfony/src/Symfony/Bundle/TwigBundle/Resources/views', 'Twig');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/vendor/symfony/swiftmailer-bundle/Symfony/Bundle/SwiftmailerBundle/Resources/views', 'Swiftmailer');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/vendor/doctrine/doctrine-bundle/Doctrine/Bundle/DoctrineBundle/Resources/views', 'Doctrine');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/src/Blogger/BlogBundle/Resources/views', 'BloggerBlog');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/src/Blogger/AccountBundle/Resources/views', 'BloggerAccount');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/src/Acme/DemoBundle/Resources/views', 'AcmeDemo');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/vendor/symfony/symfony/src/Symfony/Bundle/WebProfilerBundle/Resources/views', 'WebProfiler');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/vendor/sensio/distribution-bundle/Sensio/Bundle/DistributionBundle/Resources/views', 'SensioDistribution');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/app/Resources/views');
        $instance->addPath('/Applications/XAMPP/xamppfiles/htdocs/blog/vendor/symfony/symfony/src/Symfony/Bridge/Twig/Resources/views/Form');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('360d88b9af41ec26038a976e01f6b1cdfc6dc88e');
    }
    ...
    protected function getValidator_BuilderService()
    {
        ...
        $instance->addXmlMappings(array(0 => '/Applications/XAMPP/xamppfiles/htdocs/blog/vendor/symfony/symfony/src/Symfony/Component/Form/Resources/config/validation.xml'));
    ...
    {
        $this->services['assetic.asset_factory'] = $instance = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/Applications/XAMPP/xamppfiles/htdocs/blog/app/../web', true);
    ...
    {
        return $this->services['assetic.cache'] = new \Assetic\Cache\FilesystemCache('/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/assetic/assets');
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev');
    }
    ...
    {
        return array(
            'kernel.root_dir' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app',
            'kernel.environment' => 'dev',
            'kernel.debug' => true,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev',
            'kernel.logs_dir' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/logs',
            'kernel.bundles' => array(
                ...
                'BloggerAccountBundle' => 'Blogger\\AccountBundle\\BloggerAccountBundle',
            ...
            'locale' => 'en',
            'secret' => '360d88b9af41ec26038a976e01f6b1cdfc6dc88e',
            'debug_toolbar' => true,
            ...
            'debug.container.dump' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/appDevDebugProjectContainer.xml',
            'debug.controller_resolver.class' => 'Symfony\\Component\\HttpKernel\\Controller\\TraceableControllerResolver',
            'debug.debug_handlers_listener.class' => 'Symfony\\Component\\HttpKernel\\EventListener\\DebugHandlersListener',
            'kernel.secret' => '360d88b9af41ec26038a976e01f6b1cdfc6dc88e',
            ...
            'session.save_path' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/sessions',
            ...
            'profiler.storage.dsn' => 'file:/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/profiler',
            ...
            'router.resource' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/assetic/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/twig',
                'charset' => 'UTF-8',
                'paths' => array(
            ...
            'swiftmailer.spool.default.memory.path' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/assetic',
            ...
            'assetic.read_from' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/../web',
            'assetic.write_to' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/../web',
            ...
            'assetic.filter.yui_css.jar' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/Resources/java/yuicompressor-2.4.6.jar',
            ...
            'doctrine.orm.proxy_dir' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/cache/dev/doctrine/orm/Proxies',
            ...
            'doctrine_migrations.dir_name' => '/Applications/XAMPP/xamppfiles/htdocs/blog/app/DoctrineMigrations',
