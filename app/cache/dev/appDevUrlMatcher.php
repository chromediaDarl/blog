    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/register')) {
            ...
            if ($pathinfo === '/register') {
                return array (  '_controller' => 'BloggerAccountBundle:Account:register',  '_route' => 'account_register',);
            }

            // account_create
            if ($pathinfo === '/register/create') {
                return array (  '_controller' => 'BloggerAccountBundle:Account:create',  '_route' => 'account_create',);
            }
